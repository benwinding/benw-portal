...
export function CardProject({ project, onAddFilterClick }: { project: Project, onAddFilterClick: (event: AddFilterEvent) => void }) {
...
function ProjectLink(props: ProjectLinkProps) {
  return <a className="flex items-center" href={props.href} target={props.samePage ? '_blank' : undefined}>
